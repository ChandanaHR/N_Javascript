...
// let f = 7
// let z = f; //z=7
// console.log(z++) //z=7, z=8
// console.log(f++) //f=7, f=8
// console.log(--z) //z=7, z=7
// console.log(f--) //f=8, f=7
// console.log(z--) //z=7 , z=6
